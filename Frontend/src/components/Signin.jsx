...
export default function Signin(props){
    ...
    useEffect(()=>{
        if (window.localStorage.getItem("UN-auth-token") && (window.location.href.includes("signin"))) {
            navigate("/")
        }
    }, [])
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (json.success) {
                localStorage.setItem('UN-auth-token', json.authtoken);
                ...
                <div className="lg:w-1/2 flex flex-col h-[100%]">
                    ...
                    <form className="flex flex-col lg:w-1/2 my-auto " onSubmit={handleSubmit}>
                        ...
                        >
                            ...
                            <option name="role" value="ngo">N.G.O</option>
                            <option name="role" value="ps">P.S</option>
                            <option name="role" value="gov">Government</option>
                            <option name="role" value="sa">System Admin</option>
                        </select>
