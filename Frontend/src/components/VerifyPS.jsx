...
const VerifyPS = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('http://localhost:5000/api/auth/ps');
            if (!response.ok) {
            ...
            <table className="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <th className="border px-4 py-2">Name of the Company</th>
                        <th className="border px-4 py-2">Company Email</th>
                ...
                <tbody>
                    {data.map((item, i) => (
                        <tr key={i + 1}>
                            ...
                            <td className="border px-4 py-2">{item.ps_name}</td>
                            <td className="border px-4 py-2">{item.email}</td>
                            <td className="border px-4 py-2">{item.ps_location}</td>
