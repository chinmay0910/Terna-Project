                    ...
                    <div key={index} className="flex md:flex-row flex-col items-center">
                        ...
                        <div>
                            ...
                            <button
                                    ...
                                    style={{ backgroundColor: event.collaborators.includes(userId) ? 'green' : 'blue', color: 'white' }}
                                >
                                    {event.collaborators && event.collaborators.includes(userId) ? 'ALREADY JOINED' : 'COLLABORATE'}
                                </button>
...
export default UpcomingNgoEvents;
